...
class GenerateRelProposalLabelsOp(nn.Module):
    ...
    def forward(self, sbj_rois, obj_rois, det_rois, roidb, im_info, sbj_inds, obj_inds, det_labels):
        ...
        json_dataset_rel.add_rel_proposals(roidb, sbj_rois, obj_rois, det_rois, im_scales, sbj_inds, obj_inds, det_labels)
        #print(roidb)
        #print(sbj_rois.shape) #(3902, 5)
        
        output_blob_names = ['sbj_rois', 'obj_rois', 'det_rois', 'rel_rois', 'fg_prd_labels_int32', 'all_prd_labels_int32', 'fg_size', 'sbj_inds', 'obj_inds', 'det_labels', 'multi_prd_labels_int32', 'keep_pair_class_int32']
